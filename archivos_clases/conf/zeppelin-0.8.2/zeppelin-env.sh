...
export ZEPPELIN_INTP_MEM="-Xmx3g -Dspark.master=local[*] -Dspark.sql.catalogImplementation=hive"       		# zeppelin interpreter process jvm mem options. Default -Xms1024m -Xmx1024m -XX:MaxPermSize=512m
